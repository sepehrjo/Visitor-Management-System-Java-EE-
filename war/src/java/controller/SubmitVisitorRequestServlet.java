...
@WebServlet(name="SubmitVisitorRequestServlet", urlPatterns={"/SubmitVisitorRequestServlet"})
public class SubmitVisitorRequestServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.setAttribute("message", "Visitor request submitted successfully.");
            request.getRequestDispatcher("submitRequest.jsp").forward(request, response);
